...
@section('styles')
    <style type="text/css">
        ...
        .bg-image--19{
            position: relative;
            background-image: url('/assets/planet/bg-planet.png');
        ...
        <div class="container">
            <div class="breadcrumb-inner">
                ...
                <div class="page-title">
                    <h1 class="title">Zona HomPim Planet</h1>
                    <span style="color: white;">Membangun Kecerdasan Emosional dan Resiliensi Si Kecil</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="edu-gallery-area edu-section-gap">
        <div class="container">
            <div class="section-title section-center sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <h2 class="title" style="color: white;">Menempa Imajinasi serta Resiliensi Si Kecil di HomPim Planet</h2>
                <small class="pre-title" style="color: #E2DFD2;">Di Hompim Planet, kami percaya bahwa permainan bukan sekadar tentang hadiah yang didapat, melainkan tentang perjalanan perasaan yang dialami si kecil. Area ini khusus dirancang sebagai laboratorium emosi yang aman, di mana anak-anak belajar mengelola harapan, merayakan keberhasilan, dan yang paling penting adalah bangkit kembali dari kegagalan dengan senyuman.</small>
            ...
            <div class="isotope-wrapper">
                ...
                <div class="isotope-list gallery-grid-wrap">
                    <div id="animated-thumbnials">
                        ...
                        <div class="row row-cols-lg-3 row-cols-md-3 row-cols-2 g-5">
                            @foreach ($data as $key => $value)
                                <!-- Start Instructor Grid  -->
                                <div class="col isotope-item {{ $value->planet_category }}">
                                    <div class="edu-team-grid team-style-1">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 style="margin-top: -30px;"><a class="planet-name" href="{{url('/planet')}}/{{ $value->planet_code }}">{{ $value->planet_name }}</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
