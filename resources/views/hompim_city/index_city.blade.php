...
@section('title')
    HomPim City | Edutainment Destination
@endsection
...
@section('styles')
    <style type="text/css">
        ...
        .bg-image--19{
            position: relative;
            background-image: url('/assets/city/bg-city.png');
    ...
    <div class="edu-breadcrumb-area breadcrumb-style-2 bg-image bg-image--19" style="margin-top: -90px;">
        <div class="container">
            <div class="breadcrumb-inner">
                <div class="thumbnail">
                    <a href="#">
                        <img src="{{url('assets')}}/home/hompimcity-logo.png" alt="city images">
                    </a>
                </div>
                <div class="page-title">
                    <h1 class="title">Zona HomPim City</h1>
                    <span style="color: white;">Pusat Hobi dan Kreativitas: Tempat Imajinasi dan Strategi Si Kecil Bertemu!</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="edu-gallery-area edu-section-gap">
        <div class="container">
            <div class="section-title section-center sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <h2 class="title" style="color: white;">10 Permainan Edukasi</h2>
                <small class="pre-title" style="color: #E2DFD2;">Masuki dunia penuh tantangan di HomPim City! 
                    Jelajahi 10 wahana ikonik seperti Remote Control Arena, Shooting Target, hingga Bayblade yang melatih sensorik dan motorik halus. 
                    Di sini, Si Kecil diajak untuk berkompetisi secara sehat sekaligus melatih koordinasi melalui permainan seru 
                    seperti Speed Grab dan Fubeca Race dalam lingkungan yang edukatif dan menyenangkan.</small>
                    ...
                    <div id="animated-thumbnials">
                        ...
                        <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 g-5">
                            @foreach ($data as $key => $value)
                                ...
                                <div class="col isotope-item {{ $value->city_category }}">
                                    <div class="edu-team-grid team-style-1">
                                        <div class="inner">
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <a href="{{url('/city')}}/{{ $value->city_code }}">
                                                        <img src="{{url('assets')}}/city/{{ $value->city_thumb }}" alt="city images">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="content">
                                                <h6 style="margin-top: -30px;"><a class="city-name" href="{{url('/city')}}/{{ $value->city_code }}">{{ $value->city_name }}</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
