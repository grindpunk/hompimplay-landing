        ...
        <div class="container">
            <div class="breadcrumb-inner">
                ...
                <div class="page-title">
                    <h1 class="title">Zona HomPim Park</h1>
                    <span style="color: white;">Kecepatan Tanpa Batas Usia: Keseruan Balap Keluarga dan Adu Adrenalin di Hompim Kart</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="edu-gallery-area edu-section-gap">
        <div class="container">
            <div class="section-title section-center sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <h2 class="title" style="color: white;">7 Permainan Memacu Adrenalin</h2>
                <small class="pre-title" style="color: #E2DFD2;">HomPim Park adalah arena petualangan keluarga multi-level yang aman dan energik. 
                    Arena ini memadukan tantangan Motorik Kasar dengan zona Sensorik dan Ketangkasan, 
                    bertujuan menstimulasi perkembangan motorik, mengasah ketangkasan, dan menumbuhkan keberanian Si Kecil.</small>
                    ...
                    <div id="animated-thumbnials">
                        ...
                        <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 g-5">
                            @foreach ($data as $key => $value)
                                ...
                                <div class="col isotope-item {{ $value->park_category }}">
                                    <div class="edu-team-grid team-style-1">
                                        <div class="inner">
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <a href="{{url('/park')}}/{{ $value->park_code }}">
                                                        <img src="{{url('assets')}}/park/{{ $value->park_thumb }}" alt="park images">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="content">
                                                <h6 style="margin-top: -30px;"><a class="park-name" href="{{url('/park')}}/{{ $value->park_code }}">{{ $value->park_name }}</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
