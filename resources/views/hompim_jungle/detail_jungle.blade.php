                    ...
                    <div class="blog-details-content">
                        <div class="entry-content">
                            <ul class="blog-meta">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/jungle')}}">Hompim Jungle</a></li>
                                <li class="separator"><i class="icon-angle-right"></i></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $data->jungle_name }}</li>
                            </ul>
                            <div class="row">
                                <div class="col-lg-2 col-sm-12" id="pagination-mob" style="display: none;">
                                    <ul class="edu-pagination justify-content-center pt-0 pb-3">
                                        <li><a href="{{ $prev->jungle_code }}" aria-label="Previous"><i class="icon-west"></i></a></li>
                                        <li><a href="{{ $next->jungle_code }}" aria-label="Next"><i class="icon-east"></i></a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="thumbnail">
                                <img src="{{url('assets')}}/jungle/{{ $data->jungle_img }}" alt="Blog Image">
                            </div>
                        </div>
                                    ...
                                    <div class="edu-team-grid team-style-1">
                                        <div class="inner">
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <a href="{{url('/jungle')}}/{{ $val_random->jungle_code }}">
                                                        <img src="{{url('assets')}}/jungle/{{ $val_random->jungle_img }}" alt="blog images">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="content">
                                                <h5 class="title"><a href="{{url('/jungle')}}/{{ $val_random->jungle_code }}">{{ $val_random->jungle_name }}</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
