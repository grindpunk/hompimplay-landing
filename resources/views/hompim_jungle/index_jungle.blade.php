...
@section('title')
    HomPim Jungle | Edutainment Destination
@endsection
...
@section('styles')
    <style type="text/css">
        ...
        .bg-image--19{
            position: relative;
            background-image: url('/assets/jungle/bg-jungle.png');
    ...
    <div class="edu-breadcrumb-area breadcrumb-style-2 bg-image bg-image--19" style="margin-top: -90px;">
        <div class="container">
            <div class="breadcrumb-inner">
                <div class="thumbnail">
                    <a href="#">
                        <img src="{{url('assets')}}/home/hompimjungle-logo.png" alt="jungle images">
                    </a>
                </div>
                <div class="page-title">
                    <h1 class="title">Zona HomPim Jungle</h1>
    ...
    <div class="edu-gallery-area edu-section-gap">
        <div class="container">
            <div class="section-title section-center sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <h2 class="title" style="color: white;">Ragam Permainan Edukasi</h2>
                <small class="pre-title" style="color: #E2DFD2;">HomPim Jungle adalah arena petualangan keluarga multi-level yang aman dan energik. Arena ini memadukan tantangan Motorik Kasar (Wall Climbing, Zipline) dengan zona Sensorik dan Logika, bertujuan menstimulasi perkembangan motorik, mengasah logika, dan menumbuhkan keberanian Si Kecil.</small>
                    ...
                    <div id="animated-thumbnials">
                        ...
                        <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 g-5">
                            @foreach ($data as $key => $value)
                                ...
                                <div class="col isotope-item {{ $value->jungle_category }}">
                                    <div class="edu-team-grid team-style-1">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                <h6 style="margin-top: -30px;"><a class="jungle-name" href="{{url('/jungle')}}/{{ $value->jungle_code }}">{{ $value->jungle_name }}</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
